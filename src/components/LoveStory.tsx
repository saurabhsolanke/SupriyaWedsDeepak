...
const LoveStory: React.FC = () => {
  return (
    <div id="story" className="bg-primary text-text-light py-10 px-4 md:py-20 md:px-8 flex flex-col items-center text-center">
      <h2 className="font-playfair text-3xl md:text-5xl mb-12 md:mb-16 font-normal italic" data-aos="fade-down">
        Our Love Story
      </h2>
      ...
      <div className="flex flex-wrap justify-center gap-12 md:gap-16 max-w-[1000px] w-full items-center">
        ...
        <div className="relative w-[280px] h-[360px] md:w-[320px] md:h-[400px]" data-aos="zoom-in">
             {/* Polaroid 1 */}
        ...
        {/* Text Content */}
        <div className="flex-1 min-w-[300px] max-w-[450px] pt-4 text-center" data-aos="fade-up">
