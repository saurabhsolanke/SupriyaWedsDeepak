  ...
  return (
    <div className="flex flex-col">
      ...
      <div id="venues" className="flex flex-col md:flex-row min-h-auto md:min-h-[600px]">
        ...
        {/* Text Side */}
        <div className="w-full md:flex-1 bg-bg-light flex flex-col justify-center items-center p-8 md:p-16 text-center">
      ...
      <div id="itinerary" className="flex flex-col-reverse md:flex-row min-h-auto md:min-h-[700px]">
        {/* Text Side */}
        <div className="w-full md:flex-1 bg-bg-light p-8 md:p-16 flex flex-col justify-center">
          ...
          <div className="max-w-[400px] mx-auto w-full">
            {[
              { time: '12:30 PM', event: 'Vidhi' },
              { time: '4:00 PM', event: 'Engagement' },
              { time: '6:22 PM', event: 'Mangal Ashtika' },
              { time: '8:00 PM', event: 'Haldi' }
            ].map((item, index) => (
